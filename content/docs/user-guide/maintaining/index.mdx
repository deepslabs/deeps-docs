...
services:
  node1:
    image: safexn/sxn-node:pre-beta
    restart: always
    environment:
      RUST_LOG: info
    volumes:
...
git clone https://github.com/safexn/sxn-mining-scripts.git
...
The latest version of the image is: [**v0.12.19**](https://github.com/safexn/sxn-mining-scripts/blob/master/docker-compose.yml#L5)
...
services:
  occlum-keyring:
    image: safenx/sxn-occlum-keyring:<version_no>
    restart: always
    network_mode: "host"
    environment:
