...
You need to change the configuration here and replace the `<version_no>` only when the official image version is updated. Please refer to the [official release link](https://github.com/deepslabs/deeps-mining-scripts/blob/master/docker-compose.yml) for the exact version information.
