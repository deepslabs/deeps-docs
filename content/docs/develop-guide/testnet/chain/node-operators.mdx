...
**Docker** is the only available way to operate nodes on DeepS chain at the alpha testnet stage. Developers can quickly run nodes through the images posted by DeepS team via the following command:
